<!--
spec_id: SPEC-IG-QUERY-0001
title: IntentGraph — AI Query Interface (CLI)
status: draft
version: 0.1.0
...
@purpose:
  Define the mandatory structure and behaviour of the `intentgraph query`
  and `intentgraph cache` CLI sub-command groups that expose repository
  analysis as a stable, machine-queryable interface for AI agents.

@scope:
  CLI surface, cache module, query engine module.
  Does NOT govern the existing analysis pipeline or domain models.
-->

# SPEC-IG-QUERY-0001 — IntentGraph AI Query Interface (CLI)
...
### T-02 — Implement `query_engine.py`
